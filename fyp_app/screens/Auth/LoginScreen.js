...
const LoginScreen = ({ navigation }) => {
  ...
  const login = () => {
    axios.post('https://trusty-locust-teaching.ngrok-free.app/api/login', {
      email: email,
      password: password,
    })
        ...
        <View style={styles.loginBox}>
          ...
          />
            <TouchableOpacity  onPress={login}>
              ...
              <Text style={[styles.bottomText, {color:'#000'}]}>Login</Text>
              </View>
            </TouchableOpacity>
          ...
          <View style={styles.bottomTextContainer}>
            <Text style={[styles.bottomText,{fontSize:11, marginTop:15}]}>Don't have an account?</Text>
          </View>
          <TouchableOpacity onPress={() => navigation.navigate('Register')}>
              <View style={styles.bottomTextContainer}>
              <Text style={[styles.bottomText, {fontSize:11, color:'blue'}]}>Sign Up </Text>
              </View>
            </TouchableOpacity>
        </View>
      </View>
